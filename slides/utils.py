...
#     SlideDeck.objects.create(name="Welcome", week=1, order=0, template="week1_day1")
...
# def create_slide():
#     deck = SlideDeck.objects.get(pk=1)
#     Slide.objects.create(week=1, day=1, am_pm=-1, slide_number=0, deck=deck)