    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to=b'media/profile_picutures', blank=True)),
        ...
        migrations.AddField(
            model_name='question',
            name='slide',
            field=models.ForeignKey(related_name='questions', to='slides.Slide'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='action',
            name='slide',
            field=models.ForeignKey(related_name='actions', to='slides.Slide'),
            preserve_default=True,
        ),
    ]
